...
#response = requests.get('http://localhost:80/graph/frigoriferoJZ/')
...
def graph_data(s):
    ...
    if entity.exists:
        ...
        '''if entity_scost.exists:
            ...
            print('ds', ds)
            print('da',da)'''
        return render_template('graph_frigoriferoJZ.html',sensor=s,data=json.dumps(di), data2=json.dumps(d1), data3=json.dumps(de), data4=json.dumps(dp), data5=json.dumps(ds), data6=json.dumps(dap), data7=json.dumps(dan))
    else:
